    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-2 my-4 text-center text-lg-start">
          <img src="assets/images.2/logo/logotipo-preto-e-verde/logo.png" class="w-50 h-100" alt="">
        </div>
  ...
  <!-- /.navbar -->
        ...
        <div id="carousel" class="carousel slide">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="assets/images.2/banners/banner-1.png" class="d-block w-100 h-50" alt="">
            </div>

            <div class="carousel-item">
              <img src="assets/images.2/banners/banner-2.png" class="d-block w-100" alt="">
            </div>
          </div>
          <!-- /.carousel-inner -->
    ...
    <section class="banners mt-4">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6">
            <img src="assets/images.2/banners/abstrato-1.jpg" class="d-block w-100" alt="">
          </div>

          <div class="col-md-6">
            <img src="assets/images.2/banners/abstrato-2.jpg" class="d-block w-100" alt="">
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-3">
            <div class="card card-produto rounded-0 border-0 ">
              <a href="produto.php"><img src="assets/images.2/produtos/thumb/cartera-etc.jpg" class="card-img-top rounded-0" alt="..."></a>
              <div class="card-body">
          ...
          <div class="col-md-3">
            <div class="card card-produto rounded-0 border-0 ">
              <a href="produto.php"><img src="assets/images.2/produtos/thumb/camisas-etc.jpg" class="card-img-top rounded-0" alt="..."></a>
              <div class="card-body">
          ...
          <div class="col-md-3">
            <div class="card card-produto rounded-0 border-0">
              <a href="produto.php"><img src="assets/images.2/produtos/thumb/camiseta-etc.jpg" class="card-img-top rounded-0" alt="..."></a>
              <div class="card-body">

                <h5 class="card-title">Roupas Laranjas </h5>
          ...
          <div class="col-md-3">
            <div class="card card-produto rounded-0 border-0">
              <a href="produto.php"><img src="assets/images.2/produtos/thumb/chapeu-etc.jpg" class="card-img-top rounded-0" alt="..."></a>
              <div class="card-body">

                <h5 class="card-title">Chápeus e Acessórios</h5>
    ...
    <section class="container veja-mais">
      ...
      <div class="d-flex justify-content-center my-5">
        <div class="btn btn-lg btn-warning text-uppercase rounded-pill px-4">

          <a href="produtos.php" class="link-secondary link-underline-opacity-0">veja mais</a>
